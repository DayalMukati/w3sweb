                            ...
                            <div className="card-grid-2 hover-up">
                                <div className="card-grid-2-image-left">
                                    ...
                                    <div className="image-box">
                                        <img src="assets/imgs/brands/brand-1.png" alt="Web3School" />
                                    </div>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 hover-up">
                                <div className="card-grid-2-image-left">
                                    <span className="flash" />
                                    <div className="image-box">
                                        <img src="assets/imgs/brands/brand-2.png" alt="Web3School" />
                                    </div>
                                    <div className="right-info">
                                        <Link legacyBehavior href="company-details">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 hover-up">
                                <div className="card-grid-2-image-left">
                                    <span className="flash" />
                                    <div className="image-box">
                                        <img src="assets/imgs/brands/brand-3.png" alt="Web3School" />
                                    </div>
                                    <div className="right-info">
                                        <Link legacyBehavior href="company-details">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 hover-up">
                                <div className="card-grid-2-image-left">
                                    <span className="flash" />
                                    <div className="image-box">
                                        <img src="assets/imgs/brands/brand-4.png" alt="Web3School" />
                                    </div>
                                    <div className="right-info">
                                        <Link legacyBehavior href="company-details">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 hover-up">
                                <div className="card-grid-2-image-left">
                                    <span className="flash" />
                                    <div className="image-box">
                                        <img src="assets/imgs/brands/brand-5.png" alt="Web3School" />
                                    </div>
                                    <div className="right-info">
                                        <Link legacyBehavior href="company-details">
                                            <a className="name-job">Linkedin</a>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 hover-up">
                                <div className="card-grid-2-image-left">
                                    <span className="flash" />
                                    <div className="image-box">
                                        <img src="assets/imgs/brands/brand-6.png" alt="Web3School" />
                                    </div>
                                    <div className="right-info">
                                        <Link legacyBehavior href="company-details">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 hover-up">
                                <div className="card-grid-2-image-left">
                                    <span className="flash" />
                                    <div className="image-box">
                                        <img src="assets/imgs/brands/brand-7.png" alt="Web3School" />
                                    </div>
                                    <div className="right-info">
                                        <Link legacyBehavior href="company-details">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div className="card-grid-2 hover-up">
                                <div className="card-grid-2-image-left">
                                    <span className="flash" />
                                    <div className="image-box">
                                        <img src="assets/imgs/brands/brand-8.png" alt="Web3School" />
                                    </div>
                                    <div className="right-info">
                                        <Link legacyBehavior href="company-details">
