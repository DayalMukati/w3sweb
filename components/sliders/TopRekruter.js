                            ...
                            <div className="swiper-slide">
                                    ...
                                    <a href="#">
                                        <div className="item-logo">
                                            <div className="image-left">
                                                <img alt="Web3School" src="/assets/imgs/brands/brand-1.png" />
                                            </div>
                                            <div className="text-info-right">
                                                <h4>Linkedin</h4>
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                ...
                                <div className="item-5 hover-up wow animate__animated animate__fadeIn">
                                    <a href="#">
                                        <div className="item-logo">
                                            <div className="image-left">
                                                <img alt="Web3School" src="/assets/imgs/brands/brand-2.png" />
                                            </div>
                                            <div className="text-info-right">
                                                <h4>Adobe</h4>
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                ...
                                <div className="item-5 hover-up wow animate__animated animate__fadeIn">
                                    <a href="#">
                                        <div className="item-logo">
                                            <div className="image-left">
                                                <img alt="Web3School" src="/assets/imgs/brands/brand-3.png" />
                                            </div>
                                            <div className="text-info-right">
                                                <h4>Dailymotion</h4>
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                ...
                                <div className="item-5 hover-up wow animate__animated animate__fadeIn">
                                    <a href="#">
                                        <div className="item-logo">
                                            <div className="image-left">
                                                <img alt="Web3School" src="/assets/imgs/brands/brand-4.png" />
                                            </div>
                                            <div className="text-info-right">
                                                <h4>NewSum</h4>
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                ...
                                <div className="item-5 hover-up wow animate__animated animate__fadeIn">
                                    <a href="#">
                                        <div className="item-logo">
                                            <div className="image-left">
                                                <img alt="Web3School" src="/assets/imgs/brands/brand-5.png" />
                                            </div>
                                            <div className="text-info-right">
                                                <h4>PowerHome</h4>
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                ...
                                <div className="item-5 hover-up wow animate__animated animate__fadeIn">
                                    <a href="#">
                                        <div className="item-logo">
                                            <div className="image-left">
                                                <img alt="Web3School" src="/assets/imgs/brands/brand-6.png" />
                                            </div>
                                            <div className="text-info-right">
                                                <h4>Whop.com</h4>
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                ...
                                <div className="item-5 hover-up wow animate__animated animate__fadeIn">
                                    <a href="#">
                                        <div className="item-logo">
                                            <div className="image-left">
                                                <img alt="Web3School" src="/assets/imgs/brands/brand-7.png" />
                                            </div>
                                            <div className="text-info-right">
                                                <h4>Greewood</h4>
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                ...
                                <div className="item-5 hover-up wow animate__animated animate__fadeIn">
                                    <a href="#">
                                        <div className="item-logo">
                                            <div className="image-left">
                                                <img alt="Web3School" src="/assets/imgs/brands/brand-8.png" />
                                            </div>
                                            <div className="text-info-right">
                                                <h4>Kentucky</h4>
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                ...
                                <div className="item-5 hover-up wow animate__animated animate__fadeIn">
                                    <a href="#">
                                        <div className="item-logo">
                                            <div className="image-left">
                                                <img alt="Web3School" src="/assets/imgs/brands/brand-9.png" />
                                            </div>
                                            <div className="text-info-right">
                                                <h4>Qeuity</h4>
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
                                ...
                                <div className="item-5 hover-up wow animate__animated animate__fadeIn">
                                    <a href="#">
                                        <div className="item-logo">
                                            <div className="image-left">
                                                <img alt="Web3School" src="/assets/imgs/brands/brand-10.png" />
                                            </div>
                                            <div className="text-info-right">
                                                <h4>Honda</h4>
                                                <img alt="Web3School" src="/assets/imgs/template/icons/star.svg" />
