                    ...
                    <SwiperSlide>
                        <div className="card-grid-6 hover-up">
                            ...
                            <div className="card-image">
                                <div className="image">
                                    <figure>
                                        <img alt="Web3School" src="assets/imgs/page/about/user1.png" />
                                    </figure>
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="card-grid-6 hover-up">
                            ...
                            <div className="card-image">
                                <div className="image">
                                    <figure>
                                        <img alt="Web3School" src="assets/imgs/page/about/user2.png" />
                                    </figure>
                                </div>
                                <div className="card-profile">
                                    <h6>Mark Adair</h6>
                    ...
                    <SwiperSlide>
                        <div className="card-grid-6 hover-up">
                            ...
                            <div className="card-image">
                                <div className="image">
                                    <figure>
                                        <img alt="Web3School" src="assets/imgs/page/about/user3.png" />
                                    </figure>
                                </div>
                                <div className="card-profile">
                                    <h6>Mark Adair</h6>
